...
int main(int argc, char* argv[])
{
    ...
    if (!ParseCommandLine(argc, argv))
    {
        ...
        printf("  -groups N        Currently compile-time only (V45_PNT_GROUP_CNT in defs.h).\n");
        printf("                   Use scripts/bench_psck.sh to sweep values for your GPU.\n");
        printf("                   Runtime support under evaluation for a future release.\n");
